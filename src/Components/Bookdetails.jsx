        ...
        <div className=' p-8 bg-white lg:p-16 lg:pl-10 lg:w-1/2'>
          ...
          <p className='mb-5 text-gray-900'>Rating: {rating}</p>
          {
            fold ? <>
              ...
              <span className='cursor-pointer font-bold text-slate-500 hover:text-orange-500' onClick={() => setFold(!fold)}>Read More</span>
              {/* <span onClick={() => setFold(false)}>Read More</span> */}
            </> :
              <>
                <p className='mb-5 text-gray-500'>{desc}</p>
                <span className='cursor-pointer font-bold text-slate-500 hover:text-orange-500' onClick={() => setFold(true)}>Read Less</span>
              </>
          }
